  ...
  <div id="slide2" className="carousel-item relative w-full">
    ...
    <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#1515158f] to-[rgba(21, 21, 21, 0)]">
       <div className=' space-y-2'>
          <h2 className='text-2xl text-yellow-300 font-bold w-[50%] mx-auto mr-16'>Automotive design blends art and engineering seamlessly.</h2>
          <p className=' text-sm text-white w-[60%] mx-auto mr-16'>Leading automotive brands like Toyota, Ford, and BMW continuously innovate, offering a wide range of vehicles to meet global demand.</p>
          ...
          <button class="btn btn-warning px-6">Latest More</button>
          </div>
       </div>
    </div>
    <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
